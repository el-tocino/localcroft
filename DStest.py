...
responsed = post("http://192.168.10.240:1880/stt", data=def_audio.read())
print ("now frequency filtered...",elapsedtime())
response1 = post("http://192.168.10.240:1880/stt", data=stt_audio.read())
print ("and normalized...", elapsedtime())
response2 = post("http://192.168.10.240:1880/stt", data=ntt_audio.read())
print ("and just de-noised...", elapsedtime())
response3 = post("http://192.168.10.240:1880/stt", data=jdn_audio.read())
print ("and de-noised + normalized...", elapsedtime())
response4 = post("http://192.168.10.240:1880/stt", data=dnn_audio.read())
print ("and normalized + denoised...",elapsedtime())
response5 = post("http://192.168.10.240:1880/stt", data=nzd_audio.read())
print ("and original denoised...",elapsedtime())
response6 = post("http://192.168.10.240:1880/stt", data=odn_audio.read())
print ("denoize+filter+normalized...",elapsedtime())
response7 = post("http://192.168.10.240:1880/stt", data=dfz_audio.read())
