...
def transcribe(filename):
    ...
    response = post(self.dsurl, data=transaudio.read())
    return response
...
#parser.add_argument("-O", "--order", default="lhdn", help="filter application order (dnlh=denoise, normalize, highpass, lowpass. Default is low, high, denoise, normalize)")
